...
function displayHotelData(hotel) {
    ...
    const imageHtml = hotel.image_url
        ? `<img src="${escapeHtml(hotel.image_url)}" alt="${escapeHtml(hotel.hotel_name)}" class="hotel-header-image" onerror="this.outerHTML='<div class=\\'hotel-header-image-placeholder\\'><svg xmlns=\\'http://www.w3.org/2000/svg\\' viewBox=\\'0 0 24 24\\' fill=\\'none\\' stroke=\\'currentColor\\' stroke-width=\\'1.5\\'><path d=\\'M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z\\'></path><polyline points=\\'9 22 9 12 15 12 15 22\\'></polyline></svg></div>'">`
        : `<div class="hotel-header-image-placeholder">
    ...
    container.innerHTML = `
        ...
        <div class="hotel-header">
            <div class="hotel-header-with-image">
                <div class="hotel-header-image-container">
                    ${imageHtml}
                </div>
                <div class="header-actions-row" style="flex: 1;">
