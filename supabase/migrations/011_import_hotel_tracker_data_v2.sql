...
-- Insert all tracker entries using dollar-quoted strings to avoid escaping issues
...
What changed - Actual class size last two classes checked in at 18 rooms.

Sky West came in with 18 rooms, now at 18.
Contracted versus blocked - contract still shows 70; we had already cut blocks to 35, then 30.

The contract is 70, then went down to 35.
...
Sky West checks out on December 3rd this year; last year they did not check out until December 23rd.
Why the drop - tighter upfront screening means fewer trainees and no mid-stay failures.

They are vetting their candidates clearly much better; when they were coming in at 48, five or eight failed and were sent home.
Actions already taken - Block washed, June/July block cut to 18 in GRO; matching cut coming in R&I.

We will go even, wash it in Grow.
...
We have government booking the ginormous double-queen-king rooms at 142. We have got to get that turned off.
Decisions needed - Reset standing block, cap future classes at 20 rooms (drop to 15 if next class again lands at 18).

Re-forecast P&L - remove roughly 2,250 room-nights (approx USD 350k at 155 USD ADR).

Renegotiate contract - seek sliding guarantee: pay only for rooms above 20 per night.

We continue to be left holding the bag.
...
Next steps - Revenue & Sales finalise block wash in both systems by 17 May. Finance delivers revised forecast by 24 May. GM/Sales to call SkyWest procurement week of 26 May to discuss volume commitment. Ops adjusts crew-related staffing from July onward.$$),
...
Update room info
• Update facilities$$),
(get_hotel_id('Hyatt House Columbus Osu / Short – North'), get_company_id('Concord'), '2025-07-25', true, 'Tactic', 'Strategic Alignment: Setting up regular commercial strategy calls (Dan team + Christine + new RM + commercial team)', 'Strategic Alignment: Setting up regular commercial strategy calls (Dan team + Christine + new RM + commercial team)'),
(get_hotel_id('Hyatt House Columbus Osu / Short – North'), get_company_id('Concord'), '2025-07-25', true, 'Tactic', 'Traffic Investigation: Christine team to analyze March traffic decline (SEO changes? Traffic pattern shifts?)', NULL),
...
(get_hotel_id('Renaissance Raleigh North Hills'), get_company_id('Concord'), '2025-04-21', true, 'Issue', 'Low Review Score, Low ROI for Band Spend', $$For RHR Raleigh, Melissa mentioned that the start of the renovation on 3/17 (or Beautification process, as she likes to put it) was part of that reputation management hit in March. They will probably have some rollercoaster weeks depending on the work being done, but they are highly focused on minimizing impact.

Respons from Managers
The last 30-day average is at 4.4 - overall positive guest service trend. Melissa is a true pro; she will rally the team and address any GSS issues. I will shoot her a note on the March scores and make her aware of the focus.$$),
...
He will be adding multiple sales resources to the village sales team. These additional resources will be at McKibbon expense.
