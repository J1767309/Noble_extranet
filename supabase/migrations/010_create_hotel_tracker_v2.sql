...
DROP POLICY IF EXISTS "Internal users can view hotels" ON public.hotels;
...
DROP POLICY IF EXISTS "Internal users can view management companies" ON public.management_companies;
DROP POLICY IF EXISTS "Admins can insert management companies" ON public.management_companies;
DROP POLICY IF EXISTS "Admins can update management companies" ON public.management_companies;
DROP POLICY IF EXISTS "Admins can delete management companies" ON public.management_companies;

DROP POLICY IF EXISTS "Internal users can view hotel tracker" ON public.hotel_tracker;
DROP POLICY IF EXISTS "Admins can insert hotel tracker entries" ON public.hotel_tracker;
DROP POLICY IF EXISTS "Admins can update hotel tracker entries" ON public.hotel_tracker;
DROP POLICY IF EXISTS "Admins can delete hotel tracker entries" ON public.hotel_tracker;
...
-- Create indexes for better query performance (DROP IF EXISTS first)
DROP INDEX IF EXISTS idx_hotel_tracker_hotel_id;
DROP INDEX IF EXISTS idx_hotel_tracker_management_company_id;
DROP INDEX IF EXISTS idx_hotel_tracker_date_reported;
DROP INDEX IF EXISTS idx_hotel_tracker_is_current;
DROP INDEX IF EXISTS idx_hotel_tracker_type;
...
DROP TRIGGER IF EXISTS update_management_companies_updated_at ON public.management_companies;
DROP TRIGGER IF EXISTS update_hotel_tracker_updated_at ON public.hotel_tracker;
